...
class _ZefyrEditScreenState extends State<ZefyrEditScreen> {
...
//      return new Image.network(imageSource.replaceFirst('asset://', ''));
//    } else {
